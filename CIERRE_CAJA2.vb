    ...
    Public Sub impr_inventario()
        If CheckBox1.Checked = True Then
            ...
            While lecturaventas.Read()
                ...
                ListBox1.Items.Add([String].Format("{0,-11}|{1,-11}|{2,-5}|{3,-6}|{4,-6}", Mid(lecturaventas("hora_ingreso"), 11, 11), Mid(lecturaventas("hora_salida"), 11, 11), lecturaventas("tiempo"), lecturaventas("total"), lecturaventas("placa")))
